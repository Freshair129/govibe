...
|---|---|---|---|
| 1.3.0b | 2026-06-07 | active | ทำการวิเคราะห์และแยกแกนเนื้องาน (WBS) ออกจากแกนเวลา (Sprint/Cycle) และปรับการแมป H0-H6 ให้ตรงตามมาตรฐาน Agile |
| 1.2.0b | 2026-06-07 | active | เพิ่มการเชื่อมโยงระบบแกนเวลา (Sprint/Cycle) เข้ากับ Hop H0-H6 และปรับโครงสร้างหัวข้อย่อย |
