...
| `SYSTEM-08::Genesis-Knowledge-HCS-System` | `docs/features/genesis-knowledge-hcs/` |
...
## Missing Spec Watchlist
- Docs to Code System
- Diagram to Doc System
- MCP Integration Bridge
- RBAC/ABAC Governance
- Hierarchy Compaction System
- Hybrid JIT Context System
