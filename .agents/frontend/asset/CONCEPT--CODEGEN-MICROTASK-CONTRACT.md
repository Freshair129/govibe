...
> Asset classification: orchestrator reference only. This describes a general small-model codegen contract and may inform wrapper policy, but it is not default worker context for everyday A2 frontend microtasks.
