...
> Asset classification: orchestrator reference only. Use this when shaping bounded microtask orchestration or retry policy, not as default frontend worker prompt material.
