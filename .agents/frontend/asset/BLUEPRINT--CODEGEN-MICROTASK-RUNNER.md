...
> Asset classification: orchestrator reference only. Use as process inspiration for bounded frontend delegation, not as mandatory live runtime truth for GoVibe Mission Control A2 work.
