...
| Registry | `DOC-VERSION-REGISTRY` | `0.3.14+draft` | draft | ATHER / THESEUS | `docs/DOC-VERSION-REGISTRY.md` |
...
| Work Packet | `WP-15-PERSISTENT-MEMORY-MSP-RUNTIME-PHASE-3` | `0.1.0+draft` | draft | Boss (CEO) | `docs/change-control/change-requests/work-packets/WP-15-Persistent-Memory-MSP-Runtime-Phase-3.md` |
