...
| Registry | `DOC-VERSION-REGISTRY` | `0.3.71+draft` | draft | ATHER / THESEUS | `docs/DOC-VERSION-REGISTRY.md` |
...
| Master Plan | `MASTERPLAN-GOVIBE-PRODUCTION-READINESS` | `0.3.18` | approved | LYRA | `docs/roadmap/MASTERPLAN-govibe-production-readiness.md` |
