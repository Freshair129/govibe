...
|---|---|---|---|---|---|
| Standard | `STD-EXECUTION-GOVERNANCE` | `2.3.0+draft` | draft | GoVibe | `docs/STD-Execution-Governance.md` |
| Standard | `STD-DOCUMENT-VERSIONING-GOVERNANCE` | `0.1.2+draft` | draft | ATHER / THESEUS | `docs/STD-Document-Versioning-Governance.md` |
| Registry | `DOC-VERSION-REGISTRY` | `0.1.55+draft` | draft | ATHER / THESEUS | `docs/DOC-VERSION-REGISTRY.md` |
...
| Audit | `POC-H6-BUDGET-SUFFICIENCY` | `0.1.1+draft` | draft | Boss (CEO) | `docs/audit/POC-H6-Budget-Sufficiency.md` |
