...
| Registry | `DOC-VERSION-REGISTRY` | `0.1.84+draft` | draft | ATHER / THESEUS | `docs/DOC-VERSION-REGISTRY.md` |
...
| Change Request | `FUTURE-CR-CONTEXT-AUTHORITY-RUNTIME-REPAIR` | `0.1.0+draft` | draft | Boss (Product Authority) | `docs/change-requests/CR-2026-08-03-Context-Authority-Runtime-Repair.md` |
...
| Navigation | `DOCS-NAVIGATION-HUB` | `0.2.1+draft` | draft | THESEUS / ATHER | `docs/README.md` |
...
| RCA | `RCA-2026-08-03-CONTEXT-AUTHORITY-RUNTIME-REPAIR` | `0.1.0+draft` | draft | ATHER / THESEUS | `docs/rca/RCA-2026-08-03-Context-Authority-Runtime-Repair.md` |
