...
| Registry | `DOC-VERSION-REGISTRY` | `0.1.85+draft` | draft | ATHER / THESEUS | `docs/DOC-VERSION-REGISTRY.md` |
...
| Change Request | `FUTURE-CR-CONTEXT-AUTHORITY-RUNTIME-REPAIR` | `0.1.1+draft` | draft | Boss (Product Authority) | `docs/change-requests/CR-2026-08-03-Context-Authority-Runtime-Repair.md` |
