...
| Registry | `DOC-VERSION-REGISTRY` | `0.3.73+draft` | draft | ATHER / THESEUS | `docs/DOC-VERSION-REGISTRY.md` |
...
| Spec | `SPEC-WORKSPACE-SYSTEM` | `0.3.2` | approved | Boss (CEO) | `docs/specs/SPEC-Workspace-System.md` |
