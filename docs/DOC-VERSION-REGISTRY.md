...
| Registry | `DOC-VERSION-REGISTRY` | `0.1.59+draft` | draft | ATHER / THESEUS | `docs/DOC-VERSION-REGISTRY.md` |
...
| Roadmap | `ROADMAP-HYBRID-MVP` | `0.2.0+draft` | draft | LYRA | `docs/roadmap/ROADMAP-hybrid-mvp.md` |
