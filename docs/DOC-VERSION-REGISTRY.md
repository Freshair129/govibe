...
| Registry | `DOC-VERSION-REGISTRY` | `0.1.61+draft` | draft | ATHER / THESEUS | `docs/DOC-VERSION-REGISTRY.md` |
...
| API | `API-005-GOVIBE-CAPABILITY-CONTRACTS` | `2.0.0` | approved | Boss / ATHER | `docs/api/API-005-GoVibe-Capability-Contracts.md` |
