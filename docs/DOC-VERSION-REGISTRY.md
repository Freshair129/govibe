...
| Registry | `DOC-VERSION-REGISTRY` | `0.1.97+draft` | draft | ATHER / THESEUS | `docs/DOC-VERSION-REGISTRY.md` |
...
| Navigation | `DOCS-NAVIGATION-HUB` | `0.2.6+draft` | draft | THESEUS / ATHER | `docs/README.md` |
