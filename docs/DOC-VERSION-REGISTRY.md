...
| Registry | `DOC-VERSION-REGISTRY` | `0.1.20+draft` | draft | ATHER / THESEUS | `docs/DOC-VERSION-REGISTRY.md` |
...
| Group | Doc ID | Version | Status | Owner | Path |
|---|---|---|---|---|---|
| Roadmap | `ROADMAP-GOVIBE-MCP-RUNTIME` | `0.4.3` | approved | LYRA | `docs/roadmap/ROADMAP-govibe-mcp-runtime.md` |
