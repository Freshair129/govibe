...
| Registry | `DOC-VERSION-REGISTRY` | `0.3.36+draft` | draft | ATHER / THESEUS | `docs/DOC-VERSION-REGISTRY.md` |
...
| Master Plan | `MASTERPLAN-GOVIBE-PRODUCTION-READINESS` | `0.1.11+draft` | draft | LYRA | `docs/roadmap/MASTERPLAN-govibe-production-readiness.md` |
...
| ADR | `ADR-027-IN-REPO-MSP-RUNTIME-PACKAGE-BOUNDARY` | `0.2.0` | accepted | Boss (CEO) | `docs/adr/ADR-027-In-Repo-MSP-Runtime-Package-Boundary.md` |
...
| Spec | `SPEC-WORKSPACE-SYSTEM` | `0.2.2+draft` | draft | Boss (CEO) | `docs/specs/SPEC-Workspace-System.md` |
