---
title: "ADR-020: H-Axis Access Scope and Semantic Separation"
doc_id: "ADR-020-H-AXIS-ACCESS-SCOPE-SEPARATION"
status: "accepted"
version: "1.0.0"
updated: "2026-08-01"
owner: "Boss (CEO)"
...
# ADR-020: H-Axis Access Scope and Semantic Separation
...
Keeping the collision would make policy checks, architecture diagrams, APIs, and implementation symbols appear compatible while carrying different semantics. That is the sort of ambiguity computers execute very faithfully.
...
| Retrieval breadth | `retrieval_radius`, `max_hops`, or an approved retrieval-policy object |
...
- C4 and SDD diagrams require a deliberate correction rather than a global replacement
