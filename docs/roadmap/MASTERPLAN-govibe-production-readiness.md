...
| PHASE-PRD-05 | Package a repeatable clean-checkout developer trial | `docs/roadmap/MASTERPLAN-govibe-mvp-developer-trial.md` | GATE-BOOTSTRAP is met | done | 100 |
...
| PHASE-PRD-09 | Make completion states trustworthy | `docs/STD-Execution-Governance.md` | No path reaches done without a non-vacuous verification pass and runtime mutations survive a server restart | done | 100 |
...
| SPR-PRD-01 | PHASE-PRD-01 | Make the full baseline gate run on every pull request | A pull request touching only frontend code still runs the full suite | in-progress | 65 |
...
| SPR-PRD-05 | PHASE-PRD-05 | Author and verify the clean-checkout quickstart | A reviewer reaches a running Mission Control from the document alone | done | 100 |
...
| SPR-PRD-09 | PHASE-PRD-09 | Close the false-success paths and persist runtime truth | Each false-success path has a failing regression test, the roadmap overlay survives restart, and mutating mission commands are idempotent | done | 100 |
...
| TASK-PRD-004 | SPR-PRD-01 | task | Point end-to-end coverage at the running application | P1 | VIBE | review | TASK-PRD-003 | Section 3.1 GAP-02 |
...
| TASK-PRD-018 | SPR-PRD-01 | task | Close the CI coverage gaps: run mcp:smoke in CI, stop env:validate self-skipping, recover the dead and mis-laned tests | P1 | ATHER | done | TASK-PRD-003 | Section 3.3 AUD-25, AUD-26 |
| TASK-PRD-019 | SPR-PRD-02 | task | Add the cross-runtime MissionSnapshot parity contract test | P0 | ARCHON | done | TASK-PRD-005 | Section 3.3 AUD-16 |
| TASK-PRD-020 | SPR-PRD-03 | task | Remove fabricated telemetry from the D1 Reactor Run Trigger | P0 | VIBE | done | - | Section 3.3 AUD-07 |
| TASK-PRD-021 | SPR-PRD-03 | task | Distinguish disconnected, stale, and empty states per panel | P2 | VIBE | done | - | Section 3.3 AUD-24 |
| TASK-PRD-022 | SPR-PRD-04 | task | Extend H-axis remediation to the full leak sweep, fix the doc-generation template, and add a validator backstop | P1 | ATHER | done | TASK-PRD-009 | Section 3.3 AUD-14 |
| TASK-PRD-023 | SPR-PRD-07 | task | Configure and launch the in-repo MSP runtime with a promotion smoke test | P0 | VIBE | done | - | Section 3.3 AUD-01 |
| TASK-PRD-024 | SPR-PRD-07 | task | Forward contextAuthority through the hardened workflow.continue surface | P0 | VIBE | done | TASK-PRD-023 | Section 3.3 AUD-02 |
...
| TASK-PRD-026 | SPR-PRD-08 | task | Route sidecar mission commands through the RBAC decision point | P0 | ARCHON | done | - | Section 3.3 AUD-04 |
| TASK-PRD-027 | SPR-PRD-08 | task | Contain and govern docs.resolve and ingest.code file access | P0 | VIBE | done | - | Section 3.3 AUD-05 |
| TASK-PRD-028 | SPR-PRD-08 | task | Close credential exposures: child-env allowlist, WS token placement, log redaction, connector-token storage | P1 | VIBE | done | - | Section 3.3 AUD-10 |
...
| TASK-PRD-030 | SPR-PRD-09 | task | Close the three false-success paths to done | P0 | VIBE | done | - | Section 3.3 AUD-06 |
| TASK-PRD-031 | SPR-PRD-09 | task | Persist runtime roadmap mutations across restart | P1 | VIBE | done | - | Section 3.3 AUD-11 |
| TASK-PRD-032 | SPR-PRD-09 | task | Gate completion of semantic changes on recorded impact evidence and wire diff:check into a gate | P1 | ATHER | done | TASK-PRD-030 | Section 3.3 AUD-15 |
| TASK-PRD-033 | SPR-PRD-09 | task | Add idempotency to mutating mission commands | P2 | ARCHON | done | - | Section 3.3 AUD-18 |
| TASK-PRD-034 | SPR-PRD-02 | task | Bring the mission protocol spec to v2, cover all live sidecar endpoints, and register it | P1 | ATHER | done | - | Section 3.3 AUD-34 |
| TASK-PRD-035 | SPR-PRD-07 | task | Integrate the phase-1 execution dispatch gate at runAgent and StEP (CR-2026-08-19 D-01) | P0 | VIBE | done | TASK-PRD-024 | CR-2026-08-19 §6 D-01 |
| TASK-PRD-036 | SPR-PRD-07 | task | Pin replay-provider with a contract test; consumption stays deferred (CR-2026-08-19 D-04) | P2 | VIBE | done | - | CR-2026-08-19 §6 D-04 |
...
| TASK-PRD-005 | passed | passed | n/a | 2026-08-19T00:00:00Z |
...
| TASK-PRD-018 | passed | passed | n/a | 2026-08-19T00:00:00Z |
| TASK-PRD-019 | passed | passed | n/a | 2026-08-19T00:00:00Z |
| TASK-PRD-020 | passed | passed | n/a | 2026-08-19T00:00:00Z |
| TASK-PRD-021 | passed | passed | n/a | 2026-08-19T00:00:00Z |
| TASK-PRD-022 | passed | passed | n/a | 2026-08-19T00:00:00Z |
| TASK-PRD-023 | passed | passed | n/a | 2026-08-19T00:00:00Z |
| TASK-PRD-024 | passed | passed | n/a | 2026-08-19T00:00:00Z |
| TASK-PRD-025 | passed | passed | n/a | 2026-08-19T00:00:00Z |
| TASK-PRD-026 | passed | passed | n/a | 2026-08-19T00:00:00Z |
| TASK-PRD-027 | passed | passed | n/a | 2026-08-19T00:00:00Z |
| TASK-PRD-028 | passed | passed | n/a | 2026-08-19T00:00:00Z |
...
| TASK-PRD-032 | passed | passed | n/a | 2026-08-19T00:00:00Z |
| TASK-PRD-033 | passed | passed | n/a | 2026-08-19T00:00:00Z |
| TASK-PRD-034 | passed | passed | n/a | 2026-08-19T00:00:00Z |
| TASK-PRD-035 | passed | passed | n/a | 2026-08-19T00:00:00Z |
| TASK-PRD-036 | passed | passed | n/a | 2026-08-19T00:00:00Z |
...
symbol_links:
  ...
  test: e2e/app/roadmap-board.spec.ts
definition_of_done:
  acceptance_criteria:
  ...
  exit_criteria:
    - criterion: Given a regression that breaks the roadmap board, when the end-to-end suite runs, then it fails
      checked: true
changelog: >-
  Executed to review. GAP-02 confirmed as recorded, and worse than "no web server":
  playwright.config.ts set baseURL to docs/references/fixtures/LANDING-GoVibe-Mockup.html with
  webServer undefined, so the entire suite exercised a static marketing mockup and never loaded
  Mission Control -- two CI workflows ran it on every pull request and both would have passed with
  the application completely broken. playwright.config.ts now boots the real stack as a webServer
  array: Vite on a pinned port (--port 1420 --strictPort, because vite.config.ts sets strictPort
  false and would otherwise drift while Playwright waited on a stale one) and the sidecar via
  npm run mcp:dev, whose readiness is checked by port rather than an HTTP url because its routes
  require Origin plus Bearer auth and an unauthenticated probe would always read 401/403.
  scripts/mcp/bootstrap-env.mjs runs once, synchronously, before either server spawns and never
  overwrites an existing .env, so a developer local configuration survives running the suite
  (verified: the run prints ".env already exists -- leaving it untouched" and the file mtime is
  unchanged). e2e/app/roadmap-board.spec.ts waits for the transport to report CONNECTED, which
  only happens after a real round-trip with the sidecar, then cross-checks the roadmap board
  rendered feature count against the sidecar own /mission/snapshot response fetched from inside
  the loaded page, reusing the app existing auth bootstrap so the test carries no secret. The exit
  criterion was PROVED rather than asserted, and proved with a sharper regression than a null case:
  injecting an off-by-one into getRoadmapStats -- a still-positive, still-plausible number --
  failed the suite with "Expected: 6, Received: 5" and exit code 1, which is the live cross-check
  doing the work rather than the weaker greater-than-zero guard; the edit was reverted and the tree
  confirmed clean. The landing spec was kept rather than deleted: it is real coverage for a fixture
  that still exists, and its actual defect was defining what "E2E" meant for the whole repository,
  so it now has its own playwright.landing.config.ts with webServer undefined and its own
  path-filtered workflow lane, verified at 29 passed with no application server started. Evidence,
  all with real exit codes: npm run baseline:check exit 0; npx vitest run 125 files, 1042 passed,
  1 skipped; npx playwright test --project=chromium exit 0 with 1 passed and both servers booted;
  landing config exit 0 with 29 passed; injected regression exit 1. NOT claimed: the CI YAML was not
  executed inside a real GitHub Actions runner, only locally with the same commands and the same
  env-bootstrap ordering, so the workflow behaviour on a clean runner is evidenced by the pull
  request own check run rather than by this entry.
created_at: 2026-08-06T00:00:00Z,THESEUS,pending
token_telemetry:
  model_name: claude-opus-5
  context_length: 200k
...
definition_of_done:
  ...
  exit_criteria:
    - criterion: Given a contract test comparing both implementations, when either side declares a field the other lacks, then the test fails
      checked: true
changelog: Owner-approved CR-2026-08-10-MISSIONSNAPSHOT-ORCHESTRATION-CONTRACT implemented. Runtime output now conforms to explicit TypeScript and protocol-v2 snapshot/event contracts; targeted contract/runtime tests passed (23), lint and production build passed. QA passed; ATHER audit remains pending. Closed to done 2026-08-19: green baseline-check run 32226975076 on main @ commit 9bc4215 (the #166 merge, current HEAD) executed the full vitest suite including the orchestration-contract tests (missionProtocol, missionContract, snapshot-reducer), confirming the orchestration slice contract green on integrated main. Closed to done as owner-directed evidence review (Boss present in session), per the WP-16/17 precedent -- not an independent ATHER audit reproduction.
created_at: 2026-08-06T00:00:00Z,THESEUS,pending
token_telemetry:
  model_name: claude-opus-5
  context_length: 200k
...
changelog: >-
  ...
  Acceptance criterion ticked 2026-08-19 (owner-directed): green baseline-check run 32226975076 on
  main @ commit 9bc4215 (the #166 merge, current HEAD) executed the full baseline:check (env:validate,
  docs:validate, roadmap:validate, lint, vitest, test:security, build) plus mcp:smoke and msp:smoke,
  conclusion SUCCESS -- this is the actual CI run the criterion names, superseding the prior
  working-tree-only evidence. Closed to done as owner-directed evidence review (Boss present in
  session), per the WP-16/17 precedent -- not an independent ATHER audit reproduction.
...
changelog: >-
  ...
  Exit criterion ticked 2026-08-19 (owner-directed): green baseline-check run 32226975076 on main @
  commit 9bc4215 (the #166 merge, current HEAD) executed the full baseline:check including
  src/missionContract.test.ts, conclusion SUCCESS -- GATE-CONTRACT in Section 4 is marked met citing
  this run. Closed to done as owner-directed evidence review (Boss present in session), per the
  WP-16/17 precedent -- not an independent ATHER audit reproduction.
created_at: 2026-08-19T00:00:00Z,LYRA,pending
token_telemetry:
  model_name: resolved-by-router
  context_length: 200k
...
changelog: >-
  ...
  Closed to done 2026-08-19: green baseline-check run 32226975076 on main @ commit 9bc4215 (the #166
  merge, current HEAD) executed docs:validate including checkAbolishedHAxisSemantics, conclusion
  SUCCESS with zero active violations across the repository's 411+ markdown files -- GATE-SEMANTIC in
  Section 4 is marked met citing this run. Closed to done as owner-directed evidence review (Boss
  present in session), per the WP-16/17 precedent -- not an independent ATHER audit reproduction.
created_at: 2026-08-19T00:00:00Z,LYRA,pending
token_telemetry:
  model_name: resolved-by-router
  context_length: 200k
...
changelog: |
  ...
  Closed to done 2026-08-19: green baseline-check run 32226975076 on main @ commit 9bc4215 (the #166
  merge, current HEAD) re-confirms this evidence on the fully-integrated branch. Closed to done as
  owner-directed evidence review (Boss present in session), per the WP-16/17 precedent -- not an
  independent ATHER/ARCHON audit reproduction.
created_at: 2026-08-19T00:00:00Z,LYRA,pending
token_telemetry:
  model_name: resolved-by-router
  context_length: 200k
...
changelog: >-
  ...
  merge, current HEAD) re-confirms this evidence on the fully-integrated branch. Closed to done as
  owner-directed evidence review (Boss present in session), per the WP-16/17 precedent -- not an
  independent ARCHON audit reproduction.
created_at: 2026-08-19T00:00:00Z,LYRA,pending
token_telemetry:
  model_name: resolved-by-router
  context_length: 200k
...
|---|---|---|---|---|---|
| 0.3.23 | 2026-08-20 | approved | TASK-PRD-004 (P1, GAP-02) executed to review. Backlog Items row planned -> review; TC-TASK-PRD-004 0.1.0+draft -> 0.2.0+draft with symbol_links repointed to playwright.config.ts and the new e2e/app/roadmap-board.spec.ts. The E2E suite previously exercised a static marketing mockup with no web server, so both CI workflows would have passed with Mission Control entirely broken; it now boots Vite plus the sidecar and asserts on live snapshot data, cross-checking the roadmap board against the sidecar own /mission/snapshot response. All three criteria ticked on command-verified evidence, and the exit criterion was proved by injecting an off-by-one regression (a still-positive number, so the weaker greater-than-zero guard would not have caught it) and observing the suite fail with exit code 1 before reverting. This closes the last open task under SPR-PRD-01 and PHASE-PRD-01. Neither is advanced by this row: their children sit at review, and promotion is the owner ratification decision. GATE-CI is NOT re-evaluated here. No Readiness Gate flipped; the plan approved lifecycle status is unchanged. | pending | Claude Opus 5 |
