  ...
  },
  {
    ...
    inputSchema: {
      ...
      properties: {
        ...
        contextAuthority: { type: "object", description: "govibe-context-authority/v1 envelope; required for the context-resolution branch — without it the call blocks with missing_runtime_authority" },
      },
      required: ["actor", "workspacePath"],
    },
  },
